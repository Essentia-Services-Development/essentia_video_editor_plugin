...
impl ExportPreset {
    /// Creates a YouTube 1080p preset.
    #[must_use]
    pub fn youtube_1080p() -> Self {
        Self {
            name:        "YouTube 1080p".into(),
            description: "Optimized for YouTube HD upload".into(),
    ...
    /// Creates a YouTube 4K preset.
    #[must_use]
    pub fn youtube_4k() -> Self {
        Self {
            name:        "YouTube 4K".into(),
            description: "Optimized for YouTube 4K upload".into(),
            category:    PresetCategory::Social,
            settings:    ExportSettings {
                container: ContainerFormat::Mp4,
                video:     VideoEncodingSettings {
